...
//     });
//   } else {
//     $(".product__preview_wiget.slick-initialized").slick("unslick");
//   }
// });
...
const buyOneClick = new HystModal({
  linkAttributeName: "data-hystmodal",
...
$('#tabsProduct a').on('click', function (e) {
  e.preventDefault()
  $(this).tab('show')
})

$('#rewiev-tab a').on('click', function (e) {
  e.preventDefault()
  $(this).tab('show')
})
